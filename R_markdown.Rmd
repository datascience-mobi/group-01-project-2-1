...
ANOVA is used for analysis of variance
...
#expression<-c(Biomarker_df$`ESR1`, Biomarker_df$`ERBB2`, Biomarker_df$`ERBB3`, Biomarker_df$`ERBB4`, Biomarker_df$`KRT75`, #Biomarker_df$`PGR`)
#plot(expression~Marker)
```
...
Kruskal-Wallis-Test
The p value ist < 2.2e-16, therefore there are big differences between the biomarker.
```{r }
#library(ggpubr)
ggboxplot(df_marker, x="Marker", y="expression", color = "Marker",
        add = "jitter", legend = "none")+
