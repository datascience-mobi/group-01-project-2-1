...
```
### paired t-test over our biomarker to proof their significance
```{r}
LapatinibUntreated<-select(Untreated, contains("Lapa"))
LapatinibTreated<-select(Treated, contains("Lapa"))
before=as.matrix(LapatinibUntreated)
...
```{r}
before_biomarker<-LapUn %>% select("GDF15", "NUPR1", "DDIT3", "TRIB3", "ATF3", "ASNS" , "ESR1","ERBB2", "ERBB3", "ERBB4","KRT75", "PGR")
after_biomarker<-LapTreat%>% select("GDF15", "NUPR1", "DDIT3", "TRIB3", "ATF3", "ASNS" , "ESR1","ERBB2", "ERBB3", "ERBB4","KRT75", "PGR")
