...
In order to check whether there is a connection between the various drugs, we have colored the plot by drug.

```{r colored boxplots UNSCALED, creating a susbet of Metadata based on the amount of tested genes in Treated,echo=FALSE, fig.height = 5, fig.width = 7}
...
```{r colored boxplots SCALED, creating a susbet of Metadata based on the amount of tested genes in Treated,echo=FALSE, fig.height = 5, fig.width = 7}
...
The second linear model tries to predict the G-50 value among the data of the Doubling-time.
```{r,echo = FALSE}
NegLogGI50Lap = NegLogGI50[9,]
...
cor = cor(NLGI50.all)
pheatmap(cor, col = cm.colors(256), border_color = NA, main = "Correlation NLGI50")
